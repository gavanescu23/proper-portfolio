    ...
    <div name="experience" className="w-full h-screen">
      <div className="max-w-screen-lg mx-auto flex flex-col p-4 justify-center">
        <div className="pb-8 mt-20">
          <p className="text-gray-500 inline font-bold text-4xl border-b-4 border-gray-500 font-bodyfont ">
            Experience
          </p>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0">
          {logos.map(({ id, src, title, style }) => (
            <div
              key={id}
              className={`shadow-md font-bodyfont hover:scale-105 duration-500 py-2 rounded-lg ${style}`}
            >

  ...
  return (
    ...
    >
      <div className="font-logofont">
        <h1 className="text-5xl ml-2 text-transparent bg-clip-text bg-gradient-to-r from-cyan-700 via-cyan-300 to-purple-500">
          Găvă.
        </h1>
      </div>
      <ul className="text-2xl font-bodyfont capitalize hidden md:flex">
        {links.map(({ id, link }) => (
          <li
            key={id}
            className="px-4 cursor-pointer text-gray-500 hover:scale-105 hover:text-gray-200 duration-200"
          >

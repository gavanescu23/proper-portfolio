...
import { w1, img3, img5, img6, img7, mp1 } from "../assets/importFiles.jsx";
    ...
    <div name="portfolio" className="text-white w-full md:h-screen">
      <div className="max-w-screen-lg flex flex-col mx-auto w-full justify-center p-4 ">
        <div className="pb-8 mt-20">
          <p className="text-gray-500 inline font-bold font-bodyfont text-4xl border-b-4 border-gray-500">
            Portfolio
          </p>
          <p className="py-6 text-gray-500 font-bodyfont">
            Check out some cool images and some projects.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          {portfolios.map(({ id, src, webLink, gitLink }) => (
            <div
              key={id}
              className="shadow-md shadow-gray-700 rounded-lg flex justify-center flex-col"
            >
              <img
                className="rounded-md duration-200 hover:scale-105 h-[100%] object-cover"
                src={src}
                alt=""
              />
              <div className="flex justify-center items-center">
                <button
                  onClick={() => openInNewTab(`${webLink}`)}
                  className="w-1/2 px-6 py-3 duration-200 hover:scale-105 hover:text-gray-300 font-bodyfont text-gray-500"
                  type="button"
                >
                  Demo
                </button>
                <button
                  onClick={() => openInNewTab(`${gitLink}`)}
                  className="w-1/2 px-6 py-3 duration-200 hover:scale-105 hover:text-gray-300 font-bodyfont text-gray-500"
                >
                  Code
                </button>
